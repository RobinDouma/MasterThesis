...
M190 S67 ; bed : define temperature
M109 T12 S77 ; slot 1 : define temperature
...
M221 P2000 S1.0 T12 Z0.100 W0.335  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
