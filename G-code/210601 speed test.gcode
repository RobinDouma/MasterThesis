...
M6 T12 O2 X63 Y50 ; slot 1 : define start x & y
...
M221 P1000 S1.0 T12 Z0.05 W0.24  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
...
G1 X5 Y0 E1 F120
G1 X25 Y0 E1 F120
M221 P3000 S1.0 T12 Z0.05 W0.24  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X25 Y20 E1 F360
M221 P5000 S1.0 T12 Z0.05 W0.24  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X5 Y20 E1 F600
M221 P7000 S1.0 T12 Z0.05 W0.24  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X5 Y0.2 E1 F840
M221 P1000 S1.0 T12 Z0.05 W0.24  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
...
G4 P60000.000000 ; wait P[ms] between shapes
M722 S10000 E99999 P6000 I0 T12 ; prime
M722 S10000 E99999 P6000 I0 T12 ; prime
G92 E0 ; replace extruder position : E[mm]
...
G1 X35 Y0 E1 F120
G1 X55 Y0 E1 F120
M221 P3000 S1.0 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X55 Y20 E1 F360
M221 P5000 S1.0 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X35 Y20 E1 F600
M221 P7000 S1.0 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X35 Y0.2 E1 F840
M221 P1000 S1.0 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
