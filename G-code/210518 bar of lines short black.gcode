...
M660 H2 Z57.765 ; slot 1 : define start Z
;M660 H3 Z119.999 ; slot 2 : define start z

M6 T12 O2 X48 Y85 ; slot 1 : define start x & y
...
M221 P1000 S1 T12 Z0.100 W0.233  ; set flow : pulses[p/??l], multiplier[#], tool[#], layer[mm], nozzle[mm]
