...
M221 P1000 S2 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X20 Y1 E1 F360

M221 P1000 S3 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X35 Y1 E1 F600

M221 P1000 S4 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X50 Y1 E1 F840

M221 P1000 S5 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X65 Y1 E1 F1080
...
M221 P2000 S1 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X20 Y2 E1 F360

M221 P3000 S1 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X35 Y2 E1 F600

M221 P4000 S1 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X50 Y2 E1 F840

M221 P5000 S1 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X65 Y2 E1 F1080
...
M221 P1000 S8 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X50 Y3 E1 F840

M221 P1000 S16 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X65 Y3 E1 F1080
...
M221 P8000 S1 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
G1 X50.02 Y4 E1 F840

M221 P16000 S1 T12 Z0.05 W0.233  ; set flow : pulses[p/µl], multiplier[#], tool[#], layer[mm], nozzle[mm]
